...
class WP_Query {
    ...
    public $tax_query;  //WP_Tax_Query|null
    public $meta_query = false; // WP_Meta_Query
    public $date_query = false;//
    public $queried_object;
    public $queried_object_id;
    public $request;
    public $posts; //WP_Post[]|int[]
    public $post_count = 0;
    ...
    public $comment; // WP_Comment
    public $found_posts = 0;
    public $max_num_pages = 0;
    public $max_num_comment_pages = 0;
    public $is_single = false; //bool
    public $is_preview = false;
    public $is_page = false;
    public $is_archive = false;
	public $is_date = false;//bool
	public $is_year = false;//bool
	public $is_month = false;// bool
	public $is_day = false;//bool
	public $is_author = false;//bool
	public $is_category = false;//bool
	public $is_tag = false;//bool
	public $is_tax = false;//bool
	public $is_search = false;//bool
	public $is_feed = false;//bool
	public $is_comment_feed = false;//bool
	public $is_trackback = false;//bool
	public $is_home = false;//bool
	public $is_privacy_policy = false;//bool
	public $is_404 = false;//bool
	public $is_embed = false;//bool
	public $is_paged = false;//bool
	public $is_admin = false;//bool
	public $is_attachment = false;//bool
	public $is_singular = false;//bool
	public $is_robots = false;//bool
	public $is_favicon = false;//bool
	public $is_posts_page = false;//bool
	public $is_post_type_archive = false;//bool
	private $query_vars_hash = false;//bool|string
	private $query_vars_changed = true;//bool
	public $thumbnails_cached = false;//bool
	protected $allow_query_attachment_by_filename = false;//bool
