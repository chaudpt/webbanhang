...
class wpdb {
	...
	public function prepare( $query, ...$args ) {
        ...
        //echo "<p>WPINC:".$split_query_count."</p>"; // 4
        ...
        //echo "<p>WPINC:".$split_query_count."</p>";
		$dual_use = array_intersect( $arg_identifiers, $arg_strings );
       
        //echo "<p>WPINC:".count($dual_use)."</p>"; // 0
		if ( count( $dual_use ) > 0 ) {
			wp_load_translations_early();
	...
	public function db_connect( $allow_bail = true ) {
		...
		if ( ! $this->dbh && $allow_bail ) {
			wp_load_translations_early();//load.php need WP_Locale
			...
			//echo "<p>class".get_class($wpdb->charset)."</p>";
	...
	public function get_col( $query = null, $x = 0 ) {
	    echo "<p>get_col LINE:".$query."</p>";
		if ( $query ) {
			if ( $this->check_current_query && $this->check_safe_collation( $query ) ) {
				$this->check_current_query = false;
			}
            echo "<p>get_col LINE:".__LINE__."</p>";
			$this->query( $query );
			echo "<p>get_col LINE:".__LINE__."</p>";
		}
        echo "<p>get_col LINE:".__LINE__."</p>";
