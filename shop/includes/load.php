...
function require_wp_db() {
	global $wpdb;
	require_once ABSPATH . WPINC . '/class-wpdb.php';// need mysqli_report
	if ( isset( $wpdb ) ) {
		return;
	}
...
//$wpdb->field_types['post_author']
//$wpdb->field_types['post_parent']
//$wpdb->field_types['menu_order']
...
//$wp_filter o dang $wp_filter[ $hook_name ] = $hook; la nhung object WP_Hook
...
function wp_not_installed() {
	if ( is_blog_installed() || wp_installing() ) { //need functions.php
	    echo "<p>ABSPATH:".ABSPATH."</p>";
        echo "<p>WPINC:".WPINC."</p>";
...
function wp_set_internal_encoding() {
	...
	if ( function_exists( 'mb_internal_encoding' ) ) {echo "<p>LINE:".__LINE__."</p>";
		$charset = get_option( 'blog_charset' );
		// phpcs:ignore WordPress.PHP.NoSilencedErrors.Discouraged
		if ( ! $charset || ! @mb_internal_encoding( $charset ) ) {
			mb_internal_encoding( 'UTF-8' );echo "<p>LINE:".__LINE__."</p>";
		}
	}
}
...
function wp_load_translations_early() {
	...
	require_once ABSPATH . WPINC . '/l10n/class-wp-translation-controller.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/l10n/class-wp-translations.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/l10n/class-wp-translation-file.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/l10n/class-wp-translation-file-mo.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/l10n/class-wp-translation-file-php.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/l10n.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/class-wp-textdomain-registry.php';echo "<p>WPINC:".__LINE__."</p>";
	require_once ABSPATH . WPINC . '/class-wp-locale.php';//WP_Locale
	require_once ABSPATH . WPINC . '/class-wp-locale-switcher.php';//WP_Locale_Switcher
...
function wp_installing( $is_installing = null ) {
	...
	if ( is_null( $installing ) ) {
		$installing = defined( 'WP_INSTALLING' ) && WP_INSTALLING;echo "<p>wp_installing LINE:".__LINE__."</p>";
	}
    ...
    echo "<p>".__FILE__."wp_installing LINE:".__LINE__."</p>";
