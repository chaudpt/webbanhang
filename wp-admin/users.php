...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://hinanashop.wordpress.com/">Documentation on Managing Users</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://hinanashop.wordpress.com/">Descriptions of Roles and Capabilities</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://hinanashop.wordpress.com/">Support forums</a>' ) . '</p>'
);
